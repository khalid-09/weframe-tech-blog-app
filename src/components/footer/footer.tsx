...
const Footer = () => {
  return (
    <footer className="px-10 py-2.5">
      <div className="mx-auto flex max-w-[75.625rem] items-center justify-between py-10">
      ...
      <div className="flex items-center justify-center gap-8 font-medium tracking-[-0.48px] text-[#666]">
